...
public class EmployeeServiceCartDTO {
    ...
    public EmployeeServiceCartDTO(String employeeID, String serviceID, String string, double servicePrice, double totalServicePrice, int hoursAllocated) {
